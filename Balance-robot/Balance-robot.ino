...
double Kp = 55; // First adjustment 300 2.3 55
double Kd = 2.5; // Second adjustment
double Ki = 500; // Third adjustment
...
void setup()
{
    ...
    mpu.setXGyroOffset(-9);     //85 284 -69 -1788
    mpu.setYGyroOffset(-62);
    mpu.setZGyroOffset(22);
    mpu.setZAccelOffset(-1228); // 1688 factory default for my test chip
